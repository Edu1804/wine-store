...
contract NFTMarket is ReentrancyGuard {
    ...
    Counters.Counter private _itemIds; //total number of bottle of wine created
    Counters.Counter private _itemsSold; //total number of bottle of wine sold

    address payable owner; //owner of the smart contract
    uint256 listingPrice = 0.05 ether; //comission to put a new bottle of wine in the wine-store
    ...
    struct MarketItem {
        ...
        uint256 harvestYear;
        string typeWine;
        address payable seller; //person selling the bottle of wine
        address payable owner; //owner of the bottle of wine
        uint256 price;
        bool sold;
    }
    ...
    function createMarketItem(
        ...
        _itemIds.increment(); //add 1 to the total number of bottle of wines created
        uint256 itemId = _itemIds.current(); //update the current item ids to the new id of the bottle of wine
        ...
        idToMarketItem[itemId] = MarketItem(
            ...
            tokenId,
            barricaTime, //amount of months in barricas until the wine is ready to get into the bottles
            harvestYear, //the year when the harvest of the grapes was done
            typeWine,
        ...
        //log the transaction with the characteristics of the bottle of wine
        ...
        //total number of bottle of wines unsold in the wine-store
        function fetchMarketItems() public view returns (MarketItem[] memory){
            uint itemCount = _itemIds.current(); //total number of items ever created
            //total number of bootle of wines that are unsold = 
            //total bottle of wines ever created - total bottle of wines ever sold
        ...
        //fetch list of the bottles of wine owned by an user
        function fetchMyNFTs() public view returns (MarketItem[] memory){
         ...
         //fetch list of bottles of wine bought by this user
